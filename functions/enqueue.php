...
function load_js_files() {
	if(!is_admin()){
		...
		wp_register_script('lodash', 'https://cdnjs.cloudflare.com/ajax/libs/lodash.js/4.17.10/lodash.min.js', false, '4.17.10', true);
		wp_register_script('scripts', get_template_directory_uri().'/js/scripts.min.js', array('jquery', 'lodash'), '1.0', true);
